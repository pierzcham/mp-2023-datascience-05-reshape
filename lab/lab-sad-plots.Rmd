---
title: "Lab - Take a sad plot and make it better"
output: 
  tufte::tufte_html:
    css: ../lab.css
...
We can generate the same plot with additional the `group` aesthetic, but ggplot2 automatically group the data for these geoms whenever you map an aesthetic to a discrete variable (as in the color example).
