---
title: "HW - La Quinta is Spanish for next to Denny's, Pt. 2"
...
Knit the R Markdown `hw.Rmd` to md (github_document) document.
...
We'll use the **tidyverse** package for much of the data wrangling and visualisation and the data lives in the **dsbox** package. Install the packages if you haven't done it yet.
...
This function is not available in R, but we have to save it in a file called
